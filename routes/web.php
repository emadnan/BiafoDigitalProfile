...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/edit_card/{id}', [CardController::class, 'edit_card'])->name('edit_card');
    ...
    // add middleware in company profile.
    ...
    Route::get('/addContactLogs/{id}', [CardController::class, 'addContactLogs'])->name('addContactLogs');

    Route::post('/delete-visting-card-backgroundImages', [CardController::class, 'deleteVisitingCardBackground'])->name('delete-visting-card-backgroundImages');
});
