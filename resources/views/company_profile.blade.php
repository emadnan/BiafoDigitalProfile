                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <h1 style="font-family:Palatino;"><b>Company Profile</b></h1>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-3">
                                        <h5 style="font-family:Palatino;font-weight:bold;font-size: 25px; text-align:left">Name</h3>
                                    </div>
                                    <div class="col-md-9">
                                        <h5 style="font-family:Palatino;font-size: 25px;">{{ $company->company_name }}</h3>
                                    </div>
                                    <div class="col-md-3">
                                        <h5 style="font-family:Palatino;font-weight:bold;font-size: 25px; text-align:left">Website</h3>
                                    </div>
                                    <div class="col-md-9">
                                        <h5 style="font-family:Palatino;font-size: 25px;">{{ $company->website }}</h3>
                                    </div>
                                    <div class="col-md-3">
                                        <h5 style="font-family:Palatino;font-weight:bold;font-size: 25px; text-align:left">Linkedin</h3>
                                    </div>
                                    <div class="col-md-9">
                                        <h5 style="font-family:Palatino;font-size: 25px;">{{ $company->linkedin }}</h3>
                                    </div>
                                    <div class="col-md-3">
                                        <h5 style="font-family:Palatino;font-size: 25px;font-weight:bold; text-align:left">Address</h3>
                                    </div>
                                    <div class="col-md-9">
                                        <h5 style="font-family:Palatino;font-size: 25px;">{{ $company->address }}</h3>
                                    </div>
                                    <div class="col-md-3">
                                        <h5 style="font-family:Palatino;font-weight:bold;font-size: 25px; text-align:left">City</h3>
                                    </div>
                                    <div class="col-md-9">
                                        <h5 style="font-family:Palatino;font-size: 25px;">{{ $company->city->name }}</h3>
                                    </div>
                                    <div class="col-md-3">
                                        <h5 style="font-family:Palatino;font-weight:bold;font-size: 25px; text-align:left">Country</h3>
                                    </div>
                                    <div class="col-md-9 mb-5">
                                        <h5 style="font-family:Palatino;font-size: 25px;">{{ $company->country->name }}</h3>
                                    </div>
                                    <button class="btn btn-primary d-grid col-3" id="edit_profile"><span><i class="fa-solid fa-pen-to-square"></i> Edit</span></button>
                                </div>
                            </div>
                            <div class="col-md-6 mt-5">
                                ...
                                <div class="mt-5">
                                    <div class="mt-5">
                                        <img src="{{ asset('company_logos') }}/{{ $company->logo }}" alt="image preview"
                                            class="img-fluid rounded mx-auto d-block mt-5" style="height: 200px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company_website"
                                            id="company_website" placeholder="Enter Your Company Website"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="company_address" id="company_address" placeholder="Enter Your Company Address">{{ $company->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
