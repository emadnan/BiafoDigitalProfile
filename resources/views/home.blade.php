...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <input type="hidden" id="is_first" value="{{ $is_first }}">
        <div class="container">
                            ...
                            <a style="text-decoration: none; color: black;" href="/view_card/{{ $card->id }}/work">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <img src="{{ asset('card_images') }}/{{ $card->image_path }}"
                                                    alt="image preview" class="profile_card_img">
                                            </div>
                        ...
                        <form id="add_csv_form" action="/csv_import" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <help>CSV file should be in this format: <a
                                        href="{{ asset('sample_csv/sample.csv') }}">Download Sample</a> and don't forget
                                    to
                            ...
                            <div class="row mt-3 mb-3">
                                <div class="col-md-12 d-flex justify-content-center">
                                    <img src="{{ asset('frontend/img/logo_here.png') }}" alt="image preview"
                                        id="logo_preview" style="height: 200px; padding:10px;border: 5px solid;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="company_address" id="company_address" placeholder="Enter Your Company Address"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <iframe id="invoice_frame" src="" frameborder="0"
