                ...
                <form id="add_profile" action="/update_profile" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="city" name="city"
                                    placeholder="Enter Your City" value="{{$profile->city}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row" id="socials">
                        ...
                        <div class="col-md-6" id="exist_social_name_{{$social->id}}">
                            <div class="form-group"><label for="social">Social Name:</label><select class="form-select"
                                    id="social_name" name="social_name[]" aria-label="Default select example">
                    ...
                    <div class="row" id="experiences">
                        ...
                        <div class="col-md-6" id="exist_experice_company_{{$experience->id}}">
                            <div class="form-group"><label for="company">Company:</label><input type="text"
                                    class="form-control" id="company" name="company[]" placeholder="Enter Your Company"
                    ...
                    <div class="float-right mt-3">
                        <button type="submit" class="btn btn-primary float-right mt-3 rounded-pill py-2 px-3">Submit</button>
                    </div>
                </form>
            </div>
        </div>
