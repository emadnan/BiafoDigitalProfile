    ...
    <div class="floating-container">
        ...
        <div class="element-container" id="settings-menu" style="display: none">
            ...
            @if (isset($permissions['can_customize_card']))
                <span class="float-element">
                    <a href="/customize_card_index/{{ $card->id }}/{{ $type }}"
            ...
            @if (isset($permissions['can_create_visting_card']))
                <span class="float-element">
                    <a href="/visting_card/{{ $card->id }}/{{ $type }}"
                ...
                <div class="business2 mt-5 wantradius">
                    <div class="col-md-6">
                        <div class="front float-right" id="buttom_color">
                            ...
                            <div class="avatar">
                                <div>
                                    <img src="{{ asset('card_images') }}/{{ $card->image_path }}" class="profile_img"
                                        alt="" />
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form id="update_card_form" action="/update_card/{{ $card->id }}/{{ $type }}"
