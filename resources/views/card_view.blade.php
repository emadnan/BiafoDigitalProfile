    ...
    <div class="business2">
      <div class="front">
        ...
        <div class="avatar">
          <div>
            <img
              src="{{asset('frontend/img/card_img/avatar.jpg')}}"
              alt=""
        ...
        <div class="infos">
          ...
          <div>
            ...
            <div class="ml-2">
              <p>BIAFOTECH LAKE CITY, LAHORE</p>
              <!-- <p>LAHORE</p> -->
            </div>
          </div>
        </div>
      ...
      <div class="back">
        ...
        <div class="qricon">
          <div>
            <img
              src="{{asset('frontend/img/card_img/qr code.png')}}"
              alt=""
              style="height: 80px; width: 80px; align-items: center;"
            />
