                        ...
                        <div class="card-body">
                            ...
                            <form id="add_profile">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="#" class="btn btn-primary float-right" id="add_social" style="float:right;"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="#" class="btn btn-primary float-right" id="add_skill" style="float:right;"><i
                                                class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <a href="#" class="btn btn-primary float-right" id="add_experience" style="float:right;"><i
                                                class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <a href="#" class="btn btn-primary float-right" id="add_education" style="float:right;"><i
                                                class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <a href="#" class="btn btn-primary float-right" id="add_language" style="float:right;"><i
                                                class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <a href="#" class="btn btn-primary float-right" id="add_interest" style="float:right;"><i
                                                class="fa-solid fa-plus"></i></a>
                                    </div>
                                </div>
