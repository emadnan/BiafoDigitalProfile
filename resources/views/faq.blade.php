            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-black" href="/#pricing" class="active">Pricing</a>
                        </li>
                    ...
                    <form class="d-flex ms-5 customize_mob_menu">
                        ...
                        @guest
                            @if (Route::has('login'))
                                ...
                                <a class="btn btn-blue  px-4 py-2 ml-4 text-white" href="/#pricing"
                                    style="border-radius: 10px;"><b>{{ __('Create Card') }}</b></a>
                            @endif
                        @else
                            <a class="btn btn-yellow  px-4 py-2 text-white" style="border-radius: 10px;"
                                href="#/pricing"><b>{{ __('Create Card') }}</b></a>
                            <a class="btn btn-blue  px-4 py-2 text-white ml-4" style="border-radius: 10px;"
    ...
    <div class="container card shadow-lg">
        <div class="card-body">
            {{-- <div class="row">
                <div class="col-md-12 mt-5">
                    <h1 style="font-family: Arial, Helvetica, sans-serif;"
                        class="d-flex justify-content-center mt-5 card-title">
                        <b>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 ml-3 mt-5">
                    <h2 class="mt-5" style="margin-left: 60px"><b>Contents</b></h2>
                    <p class="mt-3">
                        <a style="text-decoration:none; color:#0056D2" href="#general">
                            <h5 class="ml-4" style="margin-left: 100px">General</h5>
                        </a>
                    </p>
                    <p>
                        <a style="text-decoration:none; color:#0056D2" href="#creating-your-digital-business-cards">
                            <h5 class="ml-4" style="margin-left: 100px">Creating your digital business cards</h5>
                        </a>
                    </p>
                    <p>
                        <a style="text-decoration:none; color:#0056D2" href="#sharing-your-digital-business-cards">
                            <h5 class="ml-4" style="margin-left: 100px">Sharing your digital business cards</h5>
                        </a>
                    </p>
                    <p>
                        <a style="text-decoration:none; color:#0056D2" href="#Profile">
                            <h5 class="ml-4" style="margin-left: 100px">Profile</h5>
                        </a>
                    </p>
                    <p>
                        <a style="text-decoration:none; color:#0056D2" href="#virtual-backgrounds">
                            <h5 class="ml-4" style="margin-left: 100px">Virtual backgrounds</h5>
                        </a>
                    </p>
                </div>

                {{-- <div class="col-sm-6 align-items-start text-center">
                    <img src="{{ asset('frontend/img/faq_2.png') }}" alt="FAQs" height="100%" width="80%">
                </div> --}}
            </div>
            ...
            <section id="Profile" style="margin-left:5%;margin-right:5%; margin-bottom:5%; margin-top:3%">
        ...
        <section class="text-white text-center bg_main_content_yellowish mt-5">
            <div class="container ">
                <div class="d-flex justify-content-between text-white">
                    ...
                    <div class="py-2">
                        <p>Copyright @ 2022. <a href="#" class="text-white">Cardify.</a> All
                            rights
                            reserved.</p>
                    </div>
                </div>
