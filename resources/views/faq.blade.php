                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapsetwentythree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            share the link to your card. To share your card, simply double-tap the card
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingtwentyfour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <h5>Can I share my HiHello card with someone who doesn’t have the app?
                                                </h5>
                                            </button>
                                        </h2>
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapsetwentyeight" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                You can add digital business cards to your address book by scanning the
                                                QR Code, which will show you the profile of a user.
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingtwentynine">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    <h5>Can I store multiple digital business cards in one address book?
                                                    </h5>
                                                </button>
                                            </h2>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingthirty">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        <h5>Can I search for a specific digital business card in my
                                                            address book?</h5>
                                                    </button>
                                                </h2>
                                                <div id="collapsethirty" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        name, company, or other information.
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
